    This is a project with libraries and commands that are used in the
book _Scripting for Testers_ and also help people easily follow the
conventions of that book (if they wish).
